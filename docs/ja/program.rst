...
q_fflo           Real(3)  0.0 0.0 0.0  秩序変数の運動量. (Reciprocal fractional unit)
initial_delta    String   "random-node k-依存ギャップ関数の初期値. "random-nodeless", "random-nodal", "const
                          -less"       ant", "band-constant"から選ぶ.
================ ======== ============ ===================================================================
